...
function Home() {
  return (
    <div
      className="top-0 left-0 w-full h-screen p-5 flex gap-2 
font-poppins justify-center items-center"
    >
      ...
      >
        ...
        <Link to="/services">
          <button
            className="bg-[#FCEA96] border border-black rounded-full
py-2 px-6 hover:bg-yellow-200"
          >
            Try Now
          </button>
        </Link>
      ...
      <motion.div
        ...
        transition={{ duration: 1, type: "spring" }}
        className="homepageimg w-full flex justify-center gap-2 
items-center"
      >
