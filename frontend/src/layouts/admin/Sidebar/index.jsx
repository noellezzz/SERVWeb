...
import { logout } from '@/states/slices/auth.slice'; // Import the logout action
    ...
    isSidebarOpen && (
      <aside className='navbar relative w-64 font-poppins'>
        <div className='w-full p-5 flex items-center gap-2 '>
          ...
          <button className='w-12 h-12 flex items-center justify-center bg-gray-100 rounded-md' onClick={() => dispatch(toggleSidebar())}>
            <ChevronLeft />
          </button>
        </div>
