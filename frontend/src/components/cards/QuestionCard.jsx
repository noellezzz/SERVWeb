...
export const QuestionCard = ({
  ...
  return (
    <div className='flex flex-col bg-white h-full w-full rounded-lg  p-4'>
      ...
      <Textarea value={transcript} onChange={(e) => setTranscript(e.target.value)} className={`${typeToAnswer == true ? '' : 'opactiy-0'}'h-32 flex-grow'`} minRows={2} size='md' variant='outlined' placeholder='Say something...' />
      {typeToAnswer && <Button onClick={onNext}>Submit</Button>}
