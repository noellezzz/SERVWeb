...
class HTMXQueueListView(generic.ListView):
    model = models.Queue
...
class HTMXQueueCreateView(generic.CreateView):
    model = models.Queue
    form_class = forms.QueueForm
...
class HTMXQueueDeleteView(generic.DeleteView):
    model = models.Queue
    success_url = reverse_lazy("queues_Queue_htmx_list")
