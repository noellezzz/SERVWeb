...
class HTMXEmotionDataListView(generic.ListView):
...
class HTMXEmotionDataCreateView(generic.CreateView):
    model = models.EmotionData
    form_class = forms.EmotionDataForm
...
class HTMXEmotionDataDeleteView(generic.DeleteView):
    model = models.EmotionData
    success_url = reverse_lazy("face_recognition_EmotionData_htmx_list")
