...
class HTMXFeedbackListView(generic.ListView):
...
class HTMXFeedbackCreateView(generic.CreateView):
    model = models.Feedback
    form_class = forms.FeedbackForm
...
class HTMXFeedbackDeleteView(generic.DeleteView):
    model = models.Feedback
    success_url = reverse_lazy("feedbacks_Feedback_htmx_list")
